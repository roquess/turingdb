...
var Select = /** @class */ (function (_super) {
    ...
    function Select() {
        ...
        _this.handleItemSelect = function (item, event) {
            ...
            var menuItem = target === null || target === void 0 ? void 0 : target.closest(".".concat(core_1.Classes.MENU_ITEM));
            var menuItemDismiss = menuItem === null || menuItem === void 0 ? void 0 : menuItem.matches(".".concat(core_1.Classes.POPOVER_DISMISS));
    ...
    Select.prototype.maybeRenderClearButton = function (query) {
        return query.length > 0 ? (React.createElement(core_1.Button, { "aria-label": "Clear filter query", icon: React.createElement(icons_1.Cross, null), minimal: true, onClick: this.resetQuery, title: "Clear filter query" })) : undefined;
    };
