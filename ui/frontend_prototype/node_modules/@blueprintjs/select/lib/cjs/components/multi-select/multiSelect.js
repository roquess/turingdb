    ...
    function MultiSelect() {
        ...
        _this.getPopoverTargetRenderer = function (listProps, isOpen) {
            ...
            return function (_a) {
                ...
                React.createElement(core_1.Button, { "aria-label": "Clear selected items", disabled: disabled, icon: React.createElement(icons_1.Cross, null), minimal: true, onClick: _this.handleClearButtonClick, title: "Clear selected items" })) : undefined;
