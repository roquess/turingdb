...
export function FilmSelect({ allowCreate = false, fill, ...restProps }) {
    ...
    const itemRenderer = React.useCallback((film, props) => {
        ...
        return (React.createElement(MenuItem, { ...getFilmItemProps(film, props), roleStructure: "listoption", selected: film === selectedFilm }));
    }, [selectedFilm]);
    return (React.createElement(Select, { createNewItemFromQuery: allowCreate ? createFilm : undefined, createNewItemRenderer: allowCreate ? renderCreateFilmMenuItem : undefined, fill: fill, itemPredicate: filterFilm, itemRenderer: itemRenderer, items: items, itemsEqual: areFilmsEqual, menuProps: { "aria-label": "films" }, noResults: React.createElement(MenuItem, { disabled: true, text: "No results.", roleStructure: "listoption" }), onItemSelect: handleItemSelect, ...restProps },
        React.createElement(Button, { alignText: "left", disabled: restProps.disabled, fill: fill, icon: "film", rightIcon: "caret-down", text: maybeRenderSelectedFilm(selectedFilm) ?? "(No selection)", textClassName: classNames({
