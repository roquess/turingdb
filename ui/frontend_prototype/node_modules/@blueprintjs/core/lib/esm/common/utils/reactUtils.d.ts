 ...
 */
export declare function ensureElement(child: React.ReactNode | undefined, tagName?: keyof React.JSX.IntrinsicElements): React.ReactElement<any, string | React.JSXElementConstructor<any>> | undefined;
/**
