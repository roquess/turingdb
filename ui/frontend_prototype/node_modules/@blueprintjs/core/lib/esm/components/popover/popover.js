    ...
    function Popover() {
        ...
        _this.renderTarget = function (_a) {
            ...
            if (renderTarget !== undefined) {
                target = renderTarget(__assign(__assign(__assign({}, ownTargetProps), childTargetProps), { className: classNames(ownTargetProps.className, targetModifierClasses), 
                ...
                var clonedTarget = React.cloneElement(childTarget, __assign(__assign({}, childTargetProps), { className: classNames(childTarget.props.className, targetModifierClasses), 
                    // force disable single Tooltip child when popover is open
                    disabled: isOpen && Utils.isElementOfType(childTarget, Tooltip) ? true : childTarget.props.disabled, tabIndex: (_e = childTarget.props.tabIndex) !== null && _e !== void 0 ? _e : targetTabIndex }));
