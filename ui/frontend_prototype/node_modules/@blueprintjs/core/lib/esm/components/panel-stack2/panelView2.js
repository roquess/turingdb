...
export var PanelView2 = function (_a) {
    ...
    var maybeBackButton = previousPanel === undefined ? null : (React.createElement(Button, { "aria-label": "Back", className: Classes.PANEL_STACK_HEADER_BACK, icon: "chevron-left", minimal: true, onClick: handleClose, small: true, text: previousPanel.title, title: previousPanel.htmlTitle }));
