...
var Overlay = /** @class */ (function (_super) {
    ...
    Overlay.prototype.render = function () {
        ...
        if (usePortal) {
            return (React.createElement(portal_1.Portal, { className: this.props.portalClassName, container: this.props.portalContainer, 
                // eslint-disable-next-line deprecation/deprecation
                stopPropagationEvents: this.props.portalStopPropagationEvents }, transitionGroup));
        }
        else {
