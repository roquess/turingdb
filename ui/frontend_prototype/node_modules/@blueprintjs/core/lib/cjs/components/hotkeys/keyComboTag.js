...
var KEY_ICONS = {
    ArrowDown: { icon: React.createElement(icons_1.ArrowDown, null), iconTitle: "Down key" },
    ArrowLeft: { icon: React.createElement(icons_1.ArrowLeft, null), iconTitle: "Left key" },
    ArrowRight: { icon: React.createElement(icons_1.ArrowRight, null), iconTitle: "Right key" },
    ArrowUp: { icon: React.createElement(icons_1.ArrowUp, null), iconTitle: "Up key" },
    alt: { icon: React.createElement(icons_1.KeyOption, null), iconTitle: "Alt/Option key" },
    cmd: { icon: React.createElement(icons_1.KeyCommand, null), iconTitle: "Command key" },
    ctrl: { icon: React.createElement(icons_1.KeyControl, null), iconTitle: "Control key" },
    delete: { icon: React.createElement(icons_1.KeyDelete, null), iconTitle: "Delete key" },
    enter: { icon: React.createElement(icons_1.KeyEnter, null), iconTitle: "Enter key" },
    meta: { icon: React.createElement(icons_1.KeyCommand, null), iconTitle: "Command key" },
    shift: { icon: React.createElement(icons_1.KeyShift, null), iconTitle: "Shift key" },
};
