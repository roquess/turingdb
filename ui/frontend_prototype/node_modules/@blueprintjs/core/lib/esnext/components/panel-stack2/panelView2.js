...
export const PanelView2 = ({ panel, onClose, onOpen, previousPanel, showHeader, }) => {
    ...
    const maybeBackButton = previousPanel === undefined ? null : (React.createElement(Button, { "aria-label": "Back", className: Classes.PANEL_STACK_HEADER_BACK, icon: "chevron-left", minimal: true, onClick: handleClose, small: true, text: previousPanel.title, title: previousPanel.htmlTitle }));
