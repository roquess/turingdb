...
void Executor::runImpl(ExecutionContext* ctxt, Pipeline* pipeline, bool init) {
    if (init) {
        ...
        _activateTbl[(uint64_t)PipelineOpcode::LOOKUP_NODE_STRING_INDEX] = ACTIVATE_PTR(LookupEdgeStringIndexStep);
        _activateTbl[(uint64_t)PipelineOpcode::LOOKUP_EDGE_STRING_INDEX] = ACTIVATE_PTR(LookupNodeStringIndexStep);
        ...
        _returnTbl[(uint64_t)PipelineOpcode::LOOKUP_NODE_STRING_INDEX] = RETURN_PTR(LookupNodeStringIndexStep);
        _returnTbl[(uint64_t)PipelineOpcode::LOOKUP_EDGE_STRING_INDEX] = RETURN_PTR(LookupEdgeStringIndexStep);
    ...
    ACTIVATE_STEP(LookupNodeStringIndexStep)
    ACTIVATE_STEP(LookupEdgeStringIndexStep)
    ...
    RETURN_STEP(LookupNodeStringIndexStep)
    RETURN_STEP(LookupEdgeStringIndexStep)
