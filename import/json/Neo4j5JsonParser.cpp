...
Neo4j5JsonParser::Neo4j5JsonParser(db::DB* db, JsonParsingStats& stats)
    : _db(db),
      _stats(stats),
...
Neo4j5JsonParser::~Neo4j5JsonParser() {
    delete _wb;
}

bool Neo4j5JsonParser::parseStats(const std::string& data) {
...
bool Neo4j5JsonParser::parseNodeProperties(const std::string& data) {
...
bool Neo4j5JsonParser::parseNodes(const std::string& data, const std::string& networkName) {
...
bool Neo4j5JsonParser::parseEdgeProperties(const std::string& data) {
...
bool Neo4j5JsonParser::parseEdges(const std::string& data) {
...
db::Network* Neo4j5JsonParser::getOrCreateNetwork(const std::string& netName) {
...
db::NodeType* Neo4j5JsonParser::getOrCreateNodeType(db::StringRef name) {
